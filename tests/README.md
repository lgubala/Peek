...
| `Esc` | Dismiss, and put focus back on the link |
| `F6` | Move into the card and back out again |
...
src/                 the only place you edit
  ...
  sites/             declared.js for sites with an API, code handlers for the rest
...
scripts/build.mjs    generates Chrome/ and Firefox/
