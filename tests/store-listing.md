...
Peek puts a window in the door. Hold Alt and hover a link, and a card shows what
is actually on the other side: a recipe's ingredients and steps, an article's
